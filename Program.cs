    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    Console.Write("Deyismek istediyiniz film Id-sini daxil edin:");
                    int id = int.Parse(Console.ReadLine());

                    Film filmVikings = new Film
                    {
                        Id = 3,
                        Name = "Vikings",
                    ...
                    filmManager.Update(id, filmVikings);
                }
                ...
                {
                    Console.Write("Zalin Id-si daxil edin: ");
                    int id = int.Parse(Console.ReadLine());
                ...
                {
                    Console.Write("Deyismek istediyiniz zal Id-sini daxil edin:");
                    int id = int.Parse(Console.ReadLine());
                ...
                {
                    Console.Write("Cinema Id-ni daxil edin: ");
                    int id = int.Parse(Console.ReadLine());
